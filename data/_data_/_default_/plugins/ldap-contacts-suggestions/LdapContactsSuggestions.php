...
class LdapContactsSuggestions implements \BloonMail\Providers\Suggestions\ISuggestions
{
	/**
	 * @var string
	 */
	...
	public function Process($oAccount, $sQuery, $iLimit = 20)
	{
		...
		else if (!$oAccount || !\BloonMail\Plugins\Helper::ValidateWildcardValues($oAccount->Email(), $this->sAllowedEmails))
		{
			return array();
		}
