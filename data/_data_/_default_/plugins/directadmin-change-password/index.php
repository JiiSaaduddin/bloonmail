...
class DirectadminChangePasswordPlugin extends \BloonMail\Plugins\AbstractPlugin
{
	...
	{
		return array(
			\BloonMail\Plugins\Property::NewInstance('direct_admin_host')->SetLabel('DirectAdmin Host')
				->SetDefaultValue('')
				->SetDescription('Allowed patterns: {user:host-imap}, {user:host-smtp}, {user:domain}'),
			\BloonMail\Plugins\Property::NewInstance('direct_admin_port')->SetLabel('DirectAdmin Port')
