...
class HmailserverChangePasswordPlugin extends \BloonMail\Plugins\AbstractPlugin
{
	...
	{
		return array(
			\BloonMail\Plugins\Property::NewInstance('login')->SetLabel('HmailServer Admin Login')
				->SetDefaultValue('Administrator'),
			\BloonMail\Plugins\Property::NewInstance('password')->SetLabel('HmailServer Admin Password')
