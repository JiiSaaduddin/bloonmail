...
class HmailserverChangePasswordDriver implements \BloonMail\Providers\ChangePassword\ChangePasswordInterface
{
	/**
	 * @var string
	 */
	...
	public function PasswordChangePossibility($oAccount)
	{
		return $oAccount && $oAccount->Email() &&
			\BloonMail\Plugins\Helper::ValidateWildcardValues($oAccount->Email(), $this->sAllowedEmails);
	}

	/**
	 * @param \BloonMail\Account $oHmailAccount
	 * @param string $sPrevPassword
	 * @param string $sNewPassword
	 *
	 * @return bool
	 */
	public function ChangePassword(\BloonMail\Account $oHmailAccount, $sPrevPassword, $sNewPassword)
	{
		if ($this->oLogger)
		{
