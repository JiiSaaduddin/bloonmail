...
class LdapChangePasswordPlugin extends \BloonMail\Plugins\AbstractPlugin
{
	...
	public function configMapping()
	{
		return array(
			...
			\BloonMail\Plugins\Property::NewInstance('port')->SetLabel('LDAP port')
				...
				->SetDefaultValue(389),
			\BloonMail\Plugins\Property::NewInstance('user_dn_format')->SetLabel('User DN format')
			...
			\BloonMail\Plugins\Property::NewInstance('password_field')->SetLabel('Password field')
				->SetDefaultValue('userPassword'),
			\BloonMail\Plugins\Property::NewInstance('password_enc_type')->SetLabel('Encryption type')
