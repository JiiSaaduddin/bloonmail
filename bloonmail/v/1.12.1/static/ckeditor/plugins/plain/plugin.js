		...
		init: function(editor)
		{
			...
			editor.__textUtils = {
				plainToHtml: function(data) {
					return window.bloonmail_Utils_plainToHtml ?
						window.bloonmail_Utils_plainToHtml(data, true) : simplePlainToHtml(data);
				},
				htmlToPlain: function(data) {
					return window.bloonmail_Utils_htmlToPlain ?
						window.bloonmail_Utils_htmlToPlain(data, true) : simpleHtmlToPlain(data);
				}
			};
