<?php
	...
	if (defined('APP_VERSION'))
	{
		if (!defined('APP_START'))
		{
			...
			define('APP_VERSION_ROOT_PATH', APP_INDEX_ROOT_PATH.'bloonmail/v/'.APP_VERSION.'/');
			...
			define('APP_WEB_SITE', 'http://www.github.com/bloonmail/');
			define('APP_API_PATH', 'http://api.github.com/bloonmail/');
			define('APP_STATUS_PATH', 'http://status.github.com/bloonmail/');
			define('APP_REPOSITORY_PATH', 'http://repository.github.com/bloonmail/v1/');
			define('APP_REPO_CORE_FILE', 'http://repository.github.com/bloonmail/v2/core.{{channel}}.json');
...
//						$sClearedSiteName = preg_replace('/^(www|demo|bloonmail|webmail|email|mail|imap|imap4|smtp|pop|pop3)\./i', '', trim(APP_SITE));
...
//						}
		...
		if (defined('JMDREVOLUTION_EXIT_ON_END') && JMDREVOLUTION_EXIT_ON_END)
		{
			exit(0);
		}
	}
