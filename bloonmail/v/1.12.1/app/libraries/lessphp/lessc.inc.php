...
class lessc {
	...
	protected function newFormatter() {
		...
		$className = 'BloonMailVendor\\'.$className;
...
class lessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('BloonMailVendor\\lessc', 'preg_quote'),
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode('|',
			array_map(array('BloonMailVendor\\lessc', 'preg_quote'), $directives));
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array('BloonMailVendor\\lessc', 'preg_quote'), $stop);
