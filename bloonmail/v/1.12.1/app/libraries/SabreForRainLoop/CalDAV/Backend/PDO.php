...
namespace SabreForBloonMail\CalDAV\Backend;

use SabreForBloonMail\VObject;
use SabreForBloonMail\CalDAV;
...
class PDO extends AbstractBackend {
    ...
    public function createCalendar($principalUri, $calendarUri, array $properties) {
        ...
        if (!isset($properties[$sccs])) {
            ...
            if (!($properties[$sccs] instanceof CalDAV\Property\SupportedCalendarComponentSet)) {
                throw new DAV\Exception('The ' . $sccs . ' property must be of type: \SabreForBloonMail\CalDAV\Property\SupportedCalendarComponentSet');
            }
    ...
    protected function getDenormalizedData($calendarData) {
        ...
        if (!$componentType) {
            throw new \SabreForBloonMail\DAV\Exception\BadRequest('Calendar objects must have a VJOURNAL, VEVENT or VTODO component');
        }
     ...
     * documented by \SabreForBloonMail\CalDAV\CalendarQueryParser.
     *
     ...
     * be found in \SabreForBloonMail\CalDAV\CalendarQueryFilter. This class is as correct
    ...
    public function calendarQuery($calendarId, array $filters) {
        ...
        $result = array();
        $validator = new \SabreForBloonMail\CalDAV\CalendarQueryValidator();
