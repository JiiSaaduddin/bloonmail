 ...
 *
 * SabreForBloonMail\CalDAV\Notifications\Notification\Invite
 *
 ...
 * ==============================================
 *
 * If SabreForBloonMail\CalDAV\Property\AllowedSharingModes is returned from
...
interface SharingSupport extends NotificationSupport {
     ...
     *   * status - See the SabreForBloonMail\CalDAV\SharingPlugin::STATUS_ constants.
     *   * readOnly - boolean
