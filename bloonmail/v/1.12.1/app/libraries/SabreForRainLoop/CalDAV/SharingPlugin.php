 ...
 *
 * See:
 * SabreForBloonMail\CalDAV\Backend\SharingSupport for all the documentation.
 *
...
class SharingPlugin extends DAV\ServerPlugin {
     ...
     *
     * This function is called by SabreForBloonMail\DAV\Server, after
     * addPlugin is called.
     *
    ...
    public function initialize(DAV\Server $server) {
        ...
        $this->server = $server;
        $server->resourceTypeMapping['SabreForBloonMail\\CalDAV\\ISharedCalendar'] = '{' . Plugin::NS_CALENDARSERVER . '}shared';
