...
class CalendarQueryValidator {
     ...
     *
     * The list of filters must be formatted as parsed by \SabreForBloonMail\CalDAV\CalendarQueryParser
     *
    ...
    protected function validateTextMatch($check, array $textMatch) {
        ...
        $isMatching = \SabreForBloonMail\DAV\StringUtil::textMatch($check, $textMatch['value'], $textMatch['collation']);
    ...
    protected function validateTimeRange(VObject\Node $component, $start, $end) {
        ...
        switch($component->name) {
            ...
            case 'VFREEBUSY' :
                throw new \SabreForBloonMail\DAV\Exception\NotImplemented('time-range filters are currently not supported on ' . $component->name . ' components');
            ...
            default :
                throw new \SabreForBloonMail\DAV\Exception\BadRequest('You cannot create a time-range filter on a ' . $component->name . ' component');
