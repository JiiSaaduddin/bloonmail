...
namespace SabreForBloonMail\VObject;
...
class Component extends Node {
    ...
    public function add($a1, $a2 = null, $a3 = null) {
        ...
        if ($a1 instanceof Node) {
            ...
            throw new \InvalidArgumentException('The first argument must either be a \\SabreForBloonMail\\VObject\\Node or a string');
    ...
    public function __set($name, $value) {
        ...
        if ($value instanceof Component || $value instanceof Property) {
            ...
            throw new \InvalidArgumentException('You must pass a \\SabreForBloonMail\\VObject\\Component, \\SabreForBloonMail\\VObject\\Property or scalar type');
        }
