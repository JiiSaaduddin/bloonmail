...
namespace SabreForBloonMail\DAVACL;
...
class Plugin extends DAV\ServerPlugin {
     ...
     * @throws SabreForBloonMail\DAVACL\Exception\NeedPrivileges
     * @return bool
     */
    ...
    public function getCurrentUserPrincipal() {
        ...
        /** @var $authPlugin SabreForBloonMail\DAV\Auth\Plugin */
     ...
     *                  SabreForBloonMail\DAV\Server::getPropertiesForPath. Returned
    ...
    public function initialize(DAV\Server $server) {
        ...
        $server->resourceTypeMapping['SabreForBloonMail\\DAVACL\\IPrincipal'] = '{DAV:}principal';

        // Mapping the group-member-set property to the HrefList property
        // class.
        $server->propertyMap['{DAV:}group-member-set'] = 'SabreForBloonMail\\DAV\\Property\\HrefList';
    ...
    public function updateProperties(&$propertyDelta, &$result, DAV\INode $node) {
        ...
        if (is_null($propertyDelta['{DAV:}group-member-set'])) {
            ...
            throw new DAV\Exception('The group-member-set property MUST be an instance of SabreForBloonMail\DAV\Property\HrefList or null');
        }
