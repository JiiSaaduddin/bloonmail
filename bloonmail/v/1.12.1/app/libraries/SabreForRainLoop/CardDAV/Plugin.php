...
namespace SabreForBloonMail\CardDAV;
...
class Plugin extends DAV\ServerPlugin {
    ...
    public function initialize(DAV\Server $server) {
        ...
        $server->resourceTypeMapping['SabreForBloonMail\\CardDAV\\IAddressBook'] = '{' . self::NS_CARDDAV . '}addressbook';
        $server->resourceTypeMapping['SabreForBloonMail\\CardDAV\\IDirectory'] = '{' . self::NS_CARDDAV . '}directory';
        ...
        $server->propertyMap['{http://calendarserver.org/ns/}me-card'] = 'SabreForBloonMail\\DAV\\Property\\Href';
     ...
     * SabreForBloonMail\DAV\Browser\Plugin. This allows us to generate an interface users
