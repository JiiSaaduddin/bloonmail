...
namespace SabreForBloonMail\DAV\Property;
...
class ResponseList extends DAV\Property {
    ...
    /**
     * The only valid argument is a list of SabreForBloonMail\DAV\Property\Response
     * objects.
     *
    ...
    public function __construct($responses) {
        ...
        foreach($responses as $response) {
            if (!($response instanceof Response)) {
                throw new \InvalidArgumentException('You must pass an array of SabreForBloonMail\DAV\Property\Response objects');
            }
        }
