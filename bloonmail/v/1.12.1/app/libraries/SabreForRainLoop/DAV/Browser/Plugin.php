...
namespace SabreForBloonMail\DAV\Browser;
...
class Plugin extends DAV\ServerPlugin {
    ...
    public $iconMap = array(
        'SabreForBloonMail\\DAV\\IFile' => 'icons/file',
        'SabreForBloonMail\\DAV\\ICollection' => 'icons/collection',
        'SabreForBloonMail\\DAVACL\\IPrincipal' => 'icons/principal',
        'SabreForBloonMail\\CalDAV\\ICalendar' => 'icons/calendar',
        'SabreForBloonMail\\CardDAV\\IAddressBook' => 'icons/addressbook',
        'SabreForBloonMail\\CardDAV\\ICard' => 'icons/card',
    );
...
<body>
  ...
  <table>
    ...
    public function htmlActionsPanel(DAV\INode $node, &$output) {
        ...
        if (get_class($node)==='SabreForBloonMail\\DAV\\SimpleCollection')
            return;
