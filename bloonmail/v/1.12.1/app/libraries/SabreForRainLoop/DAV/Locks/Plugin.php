...
namespace SabreForBloonMail\DAV\Locks;
 ...
 *
 * $lockBackend = new SabreForBloonMail\DAV\Locks\Backend\File('./mylockdb');
 * $lockPlugin = new SabreForBloonMail\DAV\Locks\Plugin($lockBackend);
...
class Plugin extends DAV\ServerPlugin {
     ...
     * server
     *
     * @var SabreForBloonMail\DAV\Server
     */
    protected $server;
     ...
     * using SabreForBloonMail\DAV\Server::getPlugin
     *
     * @return string
     */
     ...
     *
     * This function should return an array with SabreForBloonMail\DAV\Locks\LockInfo objects. If there are no locks on a file, return an empty array.
     *
     ...
     * @param mixed $lastLock This variable will be populated with the last checked lock object (SabreForBloonMail\DAV\Locks\LockInfo)
    ...
    /**
     * Parses a webdav lock xml body, and returns a new SabreForBloonMail\DAV\Locks\LockInfo object
     *
     * @param string $body
