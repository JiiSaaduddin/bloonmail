...
class Server {
     ...
     * The tree object
     *
     * @var SabreForBloonMail\DAV\Tree
     */
    public $tree;
     ...
     * httpResponse
     *
     * @var SabreForBloonMail\HTTP\Response
     */
    public $httpResponse;
     ...
     * httpRequest
     *
     * @var SabreForBloonMail\HTTP\Request
     */
    public $httpRequest;
    ...
    public $propertyMap = array(
        '{DAV:}resourcetype' => 'SabreForBloonMail\\DAV\\Property\\ResourceType',
    );
     ...
     * implementing SabreForBloonMail\DAV\ICollection.
     *
     * @var array
     */
    public $resourceTypeMapping = array(
        'SabreForBloonMail\\DAV\\ICollection' => '{DAV:}collection',
    );
     ...
     * Sets up the server
     *
     * If a SabreForBloonMail\DAV\Tree object is passed as an argument, it will
     * use it as the directory tree. If a SabreForBloonMail\DAV\INode is passed, it
     * will create a SabreForBloonMail\DAV\ObjectTree and use the node as the root.
     *
     * If nothing is passed, a SabreForBloonMail\DAV\SimpleCollection is created in
     * a SabreForBloonMail\DAV\ObjectTree.
     *
        ...
        if ($treeOrNode instanceof Tree) {
            ...
            foreach($treeOrNode as $node) {
                if (!($node instanceof INode)) {
                    throw new Exception('Invalid argument passed to constructor. If you\'re passing an array, all the values must implement SabreForBloonMail\\DAV\\INode');
                }
            }
            ...
            throw new Exception('Invalid argument passed to constructor. Argument must either be an instance of SabreForBloonMail\\DAV\\Tree, SabreForBloonMail\\DAV\\INode, an array or null');
        }
     ...
     *
     * For more information, console the documentation of SabreForBloonMail\DAV\ServerPlugin
     *
     ...
     *
     * This method returns the contents of the HTTP depth request header. If the depth header was 'infinity' it will return the SabreForBloonMail\DAV\Server::DEPTH_INFINITY object
    ...
    public function updateProperties($uri, array $properties) {
        ...
        // If the node is not an instance of SabreForBloonMail\DAV\IProperties, every
