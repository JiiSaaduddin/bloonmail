...
class Client {
     ...
     * SabreForBloonMail\DAV\Property\ResourceType
     *
     * @var array
     */
    ...
    public function __construct(array $settings) {
        ...
        $this->propertyMap['{DAV:}resourcetype'] = 'SabreForBloonMail\\DAV\\Property\\ResourceType';
    ...
    public function request($method, $url = '', $body = null, $headers = array()) {
        ...
        $curlSettings = array(
			...
			CURLOPT_USERAGENT => 'BloonMail DAV Client', // TODO bloonmail
