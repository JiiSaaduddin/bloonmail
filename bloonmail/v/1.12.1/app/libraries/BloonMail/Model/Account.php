...
namespace BloonMail\Model;

class Account extends \BloonMail\Account // for backward compatibility
{
	/**
	 * @var string
	 */
	 ...
	 * @return void
	 */
	protected function __construct($sEmail, $sLogin, $sPassword, \BloonMail\Model\Domain $oDomain,
	 ...
	 */
	public static function NewInstance($sEmail, $sLogin, $sPassword, \BloonMail\Model\Domain $oDomain,
		$sSignMeToken = '', $sProxyAuthUser = '', $sProxyAuthPassword = '')
	{
	...
	{
		return \BloonMail\Utils::EncodeKeyValues(array(
			'token',							// 0
			$this->sEmail,						// 1
			$this->sLogin,						// 2
			$this->sPassword,					// 3
			\BloonMail\Utils::Fingerprint(),		// 4
			$this->sSignMeToken,				// 5
			$this->sParentEmail,				// 6
			\BloonMail\Utils::GetShortToken(),	// 7
	...
	{
		return \BloonMail\Utils::EncodeKeyValuesQ(array(
			'token',							// 0
			$this->sEmail,						// 1
			$this->sLogin,						// 2
			$this->sPassword,					// 3
	...
	/**
	 * @param \BloonMail\Plugins\Manager $oPlugins
	 * @param \MailSo\Mail\MailClient $oMailClient
	 * @param \BloonMail\Application $oConfig
	 *
	 * @return bool
	 */
