...
class TwoFactorAuth extends \BloonMail\Providers\AbstractProvider
{
	/**
	 * @var \BloonMail\Providers\TwoFactorAuth\TwoFactorAuthInterface
	 */
	private $oDriver;

	/**
	 * @param \BloonMail\Providers\TwoFactorAuth\TwoFactorAuthInterface|null $oDriver = null
	 *
	 * @return void
	 */
	...
	{
		return $this->oDriver instanceof \BloonMail\Providers\TwoFactorAuth\TwoFactorAuthInterface;
	}
