...
namespace BloonMail\Providers\Filters\Classes;
...
class Filter
{
	...
	public function Clear()
	{
		...
		$this->sConditionsType = \BloonMail\Providers\Filters\Enumerations\ConditionsType::ANY;

		$this->sActionType = \BloonMail\Providers\Filters\Enumerations\ActionType::MOVE_TO;
		$this->sActionValue = '';
	...
	public function FromJSON($aFilter)
	{
		if (\is_array($aFilter))
		{
			...
			$this->sConditionsType = isset($aFilter['ConditionsType']) ? $aFilter['ConditionsType'] :
				\BloonMail\Providers\Filters\Enumerations\ConditionsType::ANY;
			...
			$this->aConditions = \BloonMail\Providers\Filters\Classes\FilterCondition::CollectionFromJSON(
