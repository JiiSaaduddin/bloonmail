...
namespace BloonMail\Config;

class Application extends \BloonMail\Config\AbstractConfig
{
	...
	public function __construct()
	{
		parent::__construct('application.ini',
			'; BloonMail Webmail configuration file
	...
	protected function defaultValues()
	{
		return array(
			...
			'webmail' => array(
				...
				'title'							=> array('BloonMail Webmail', 'Text displayed as page title'),
				'loading_description'			=> array('BloonMail', 'Text displayed on startup'),
				'favicon_url'					=> array('', ''),
...
0 for unlimited.')
			...
			'contacts' => array(
				...
				'type'				=> array('sqlite', ''),
				'pdo_dsn'			=> array('mysql:host=127.0.0.1;port=3306;dbname=bloonmail', ''),
				'pdo_user'			=> array('root', ''),
				'pdo_password'		=> array('', ''),
			...
			'security' => array(
				...
				'custom_server_signature'	=> array('BloonMail'),
			...
			'login' => array(
				...
				'sign_me_auto'	=> array(\BloonMail\Enumerations\SignMeType::DEFAILT_OFF,
